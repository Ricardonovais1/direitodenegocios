...
export const fallbackData: SiteData = {
  ...
  practiceAreas: [
    // "Direito de negócios" saiu da lista: é o guarda-chuva que dá nome ao site,
    // e as nove áreas abaixo são justamente as suas subáreas.
    ...
    { _id: '3', number: '02', title: 'Direito societário', slug: 'direito-societario', description: 'Constituição, acordos de sócios, governança e reorganizações societárias.' },
    { _id: '4', number: '03', title: 'Direito para startups', slug: 'direito-para-startups', description: 'Do pacto de fundadores às rodadas de investimento e à escala.' },
    { _id: '5', number: '04', title: 'Direito de TI', slug: 'direito-de-ti', description: 'Software, SaaS, proteção de dados, contratos de tecnologia e o universo digital.' },
    { _id: '6', number: '05', title: 'Direito do trabalho', slug: 'direito-do-trabalho', description: 'Compliance trabalhista, redução de passivos e defesa em reclamações e ações coletivas.' },
    { _id: '7', number: '06', title: 'Propriedade intelectual', slug: 'propriedade-intelectual', description: 'Marcas, patentes e segredos de negócio protegidos de verdade.' },
    { _id: '8', number: '07', title: 'Direito de patentes', slug: 'direito-de-patentes', description: 'Proteção de invenções e inovação para quem cria tecnologia.' },
    { _id: '9', number: '08', title: 'Direito das coisas', slug: 'direito-das-coisas', description: 'Direito imobiliário e de propriedade para negócios e patrimônio.' },
    { _id: '10', number: '09', title: 'Planejamento patrimonial', slug: 'planejamento-patrimonial', description: 'Blindagem, organização e sucessão do patrimônio.' },
  ],
  process: [
  ...
  courses: [
    {
      ...
      faqs: [
        { question: 'Preciso ser advogado para fazer o curso?', answer: 'Não. O curso foi desenhado para empresários, profissionais de RH e departamentos jurídicos de empresas de T.I. e para qualquer profissional que aplica a CCT no dia a dia. A linguagem é clara e prática.' },
        { question: 'O curso cobre a convenção inteira, cláusula por cláusula?', answer: 'Sim. O objetivo é exatamente percorrer a CCT cláusula por cláusula, com interpretação e o “como fazer” de cada ponto, comentando os aspectos básicos da interação CCT x CLT e apontando os gargalos e possíveis passivos respectivos.' },
        ...
        { question: 'Por quanto tempo tenho acesso?', answer: 'O acesso à comunidade, com as perguntas e respostas comentadas pelo Autor, é de 12 meses.' },
